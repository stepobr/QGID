...
void TMVAClassificationV2( TString myMethodList = "" )
{
  ...
  // factory->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
   ...
   TString fname1 = "./DY_incl_MVA_lquark.root";
  ...
  //    gSystem->Exec("wget http://root.cern.ch/files/tmva_class_example.root");
   ...
   TString fname2 = "./DY_incl_MVA_gluon.root";
...
//+++++ add weights
    for signal    : factory->SetSignalWeightExpression    ("");
    for background: factory->SetBackgroundWeightExpression("");
   //factory->SetBackgroundWeightExpression( "weight" );

   // Apply additional cuts on the signal and background samples (can be different)
   TCut mycuts = "Pt_J>30. && Pt_J<40. "; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   TCut mycutb = "Pt_J>30. && Pt_J<40. "; // for example: TCut mycutb = "abs(var1)<0.5";
